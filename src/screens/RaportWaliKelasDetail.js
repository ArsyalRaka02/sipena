...
export default function RaportWaliKelasDetail(props) {
        ...
        <>
            <SafeAreaView style={styles.container}>
                ...
                <View style={{ padding: 20, flex: 1 }}>
                    <View style={{ backgroundColor: color.white, padding: 20, borderRadius: 12, flexDirection: 'row' }}>
                        <Text style={[styles.txtGlobalBold, { color: color.primary, fontSize: 16, flex: 1 }]}>{item.nama_siswa}</Text>
                        <Text style={[styles.txtGlobalBold, { color: color.primary, fontSize: 16 }]}>{item.nama_kelas}</Text>
                    </View>
