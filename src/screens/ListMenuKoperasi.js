...
const menu = [
    {
        name: 'Penjualan',
        icon: "reader-outline",
        page: "ListPenjualanKoperasi"
    },
    {
        name: 'Pembelian',
        icon: "reader-outline",
        page: "ListSemuaPenjualan"
    },
    {
        name: 'Daftar List',
        icon: "reader-outline",
        page: "ListAllKoperasi"
    },
]

export default function ListMenuKoperasi(props) {
    ...
    return (
        <>
            <SafeAreaView style={styles.container}>
                ...
                >
                    <Text style={styles.txtHeader}>Koperasi</Text>
                </HeaderBack>
