...
export default function ModalWarningMessage(props) {
    let isShowModal = props.isShowModal ?? false
    let isLoading = props.isLoading ?? false
    let message = props.message ?? "Peringatan Pesan"
        ...
        >
            <View style={styles.cardModalContainer}>
                <View style={{ width: 80, height: 80 }}>
                    <Image source={require("../assets/forModal/warningFrame.png")} style={styles.img} />
                </View>
