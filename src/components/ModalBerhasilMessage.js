...
export default function ModalBerhasilMessage(props) {
    let isShowModal = props.isShowModal ?? false
    let isLoading = props.isLoading ?? false
    let message = props.message ?? "Pesan Sukses"
        ...
        >
            <View style={styles.cardModalContainer}>
                <View style={{ width: 80, height: 80 }}>
                    <Image source={require("../assets/forModal/centangFrame.png")} style={[styles.img, { tintColor: color.primary }]} />
                </View>
